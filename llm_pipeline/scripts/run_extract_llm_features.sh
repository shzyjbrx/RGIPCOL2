...
#SBATCH --output=logs/mit-states/test/extract_feats_%j.out
#SBATCH --error=logs/mit-states/test/extract_feats_%j.err
...
# 3. 路径与参数配置
JSON_PATH="./LLM/mit_node_descriptions.json"
SAVE_PATH="./LLM/mit_node_features.pt"
...
python -u extract_llm_features.py \
    --json_path   ${JSON_PATH} \
    --save_path   ${SAVE_PATH} \
    --clip_path   ${CLIP_PATH} \
